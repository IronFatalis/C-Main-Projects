...
int main()
{
	...
	const string WORDS[NUM_WORDS] ={
		"wall","glasses","labored","persistent","jumble"};
	const string HINTS[NUM_HINTS] = { "Do you feel you're banging your head against something?",
	...
	string secretWord = WORDS[choice];	//word to guess
	string secretHint = HINTS[choice];	//hint for word
